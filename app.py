...
SYSTEM_PROMPT = r"""Ты — узкоспециализированный ИИ-ассистент по переводу схем в TikZ. Начинай СРАЗУ с \documentclass."""
VISION_PROMPT = r"""Проанализируй физическую схему и опиши сухими геометрическими фактами для TikZ."""
